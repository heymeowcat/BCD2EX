...
@NamedQueries({
   ...
   ,@NamedQuery(name="Attendance.findempPunchIn",query = "SELECT a FROM Attendance a WHERE SUBSTRING(a.punchIn,1,10)  = SUBSTRING(:punchIn,1,10)  AND a.employeeId = :empid")})
public class Attendance implements Serializable {
    ...
    public String toString() {
        return "EmployeeInfo.Entity.Attendance[ idAttendance=" + idAttendance + " ]";
    }
